...
futuro_files <- list.files("/Volumes/TOSHIBA EXT/COBERTURAS/CHELSA/ssp370_2011-2040/MCG_Bioclimas/", pattern = "*.tif$");futuro_files 
#x<-futuro_files [[1]];x 
...
dir.create(paste0("ssp370_",model_name,"_2011-2040_ZVH"))

# Leer los datos necesarios
futuro <- terra::rast(paste0("/Volumes/TOSHIBA EXT/COBERTURAS/CHELSA/ssp370_2011-2040/MCG_Bioclimas/CHELSA_bio_2011-2040_",model_name,"_ssp370.tif"))

ap <- futuro[[4]] # Precipitación (mm)
at <- futuro[[1]] # Temperatura
...
plot(biotTem, main = "Temperatura de 0 a 30º")

# Guardar biotemperature
terra::writeRaster(biotTem, filename = paste0("ssp370_",model_name,"_2011-2040_ZVH/biot_",model_name,".tif"), overwrite = TRUE)

# Calcular evapotranspiración potencial (pet)
pet <- biotTem * 58.93
plot(pet,main = "Evapotranspiración potencial")
terra::writeRaster(pet, filename = paste0("ssp370_",model_name,"_2011-2040_ZVH/pet_",model_name,".tif"), overwrite = TRUE)

# Calcular ratio de evapotranspiración potencial
per <- pet / ap
#plot(per, main = "Ratio de evapotranspiración potencial")
terra::writeRaster(per, filename = paste0("ssp370_",model_name,"_2011-2040_ZVH/per_",model_name,".tif"), overwrite = TRUE)
...
apCat[ap > 8000.0] <- 8
terra::writeRaster(apCat, filename = paste0("ssp370_",model_name,"_2011-2040_ZVH/apCat_",model_name,".tif"), overwrite = TRUE)
...
terra::writeRaster(latr, filename = paste0("ssp370_",model_name,"_2011-2040_ZVH/latr_",model_name,".tif"), overwrite = TRUE)
...
terra::writeRaster(provhum, filename = paste0("ssp370_",model_name,"_2011-2040_ZVH/provhum_",model_name,".tif"), overwrite = TRUE)

# Crear zonas de vida Holdridge
raster1 <- terra::rast(paste0("ssp370_",model_name,"_2011-2040_ZVH/latr_",model_name,".tif"))

raster2 <- terra::rast(paste0("ssp370_",model_name,"_2011-2040_ZVH/apCat_",model_name,".tif"))
...
raster3 <- terra::rast(paste0("ssp370_",model_name,"_2011-2040_ZVH/provhum_",model_name,".tif"))
...
terra::writeRaster(raster1, filename = paste0("ssp370_",model_name,"_2011-2040_ZVH/zvh_",model_name,".tif"), overwrite = TRUE)
